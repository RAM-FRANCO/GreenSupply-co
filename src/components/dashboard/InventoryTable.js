...
const headCells = [
  ...
  { id: 'totalQuantity', numeric: true, label: 'Total Stock' },
  { id: 'reorderPoint', numeric: true, label: 'Reorder Point' },
                ...
                <TableRow hover role='checkbox' tabIndex={-1} key={row.id}>
                  ...
                  <TableCell
                    ...
                    sx={{
                      ...
                      color: row.isLowStock ? 'error.main' : 'inherit',
                    }}
                  >
                    {row.totalQuantity}
                  </TableCell>
                  ...
                  <TableCell align='left'>
                    <Chip
                      ...
                      color={row.isLowStock ? 'error' : 'success'}
                      size='small'
                      sx={{
                        fontWeight: 500,
                        bgcolor: row.isLowStock ? '#FFCDD2' : '#C8E6C9',
                        color: row.isLowStock ? '#C62828' : '#2E7D32',
                        borderRadius: '16px',
                      }}
                    />
                  </TableCell>
